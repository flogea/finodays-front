...
async function withdrawWithAnotherToken(token, address, currency) {
  ...
  try {
    ...
    // const company = await contract.withdrawWithAnotherToken(address, currency, 1);
...
export default withdrawWithAnotherToken;
